...
# -*- coding: utf-8 -*-
"""
This is a modified version of the original file. It assumes that you have a
file called Illinois-campaign-contributions.csv in the same directory as this
file. Make sure you look at the TODO section below.
...
# This portion downloads the original csv file. We'll be using a subset of the
# original CSV file. Thus, this portion has been commented out.
'''
...
# TODO: Change the credentials to reflect your local PostgreSQL setup
DATABASE = 'postgres'
USER = 'postgres'
PASSWORD = 'postgres'
HOST = 'localhost'
...
with open(contributions_csv_file, 'r') as csv_file:
    c.copy_expert("COPY raw_table "
                  ...
                  "FROM STDIN WITH CSV HEADER DELIMITER AS ','", csv_file)
...
c.execute("INSERT INTO recipients "
          "SELECT DISTINCT CAST(COALESCE(committee_id, '0') AS INTEGER), "
